...
export default function WhatsApp() {
    ...
    const number = '9999090454'

    return (
        <Link to={`https://wa.me/${number}`} target="_blank" className="fixed size-11 z-50 right-5 bottom-5 rounded-full flex items-center justify-center cursor-pointer bg-[#46E763] transition-all hover:bg-[#46E763]/90 hover:-translate-y-1">
